...
const searchProduct = (code) => {
    return newData[code] ? newData[code].name : 'Không tìm thấy sản phẩm';
};

console.log(searchProduct('ab')); // Output: Son môi
console.log(searchProduct('ac')); // Output: Sữa rửa mặt
console.log(searchProduct('ad')); // Output: Không tìm thấy sản phẩm